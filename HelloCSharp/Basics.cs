...
// Solution (root) - projects (Cmake) - cs (cpp)
    ...
    public class Basics // все в классах 
    {
        ...
        // Лямбда	Кратко описать поведение (анонимную функцию)
        // Делегат	Представляет "сигнатуру" функции (что принимает/возвращает)
        // LINQ	Набор методов, принимающих делегаты и выполняющих над ними действия (фильтрация, сортировка и т.д.)
